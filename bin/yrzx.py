...
async def main():
    urls = [f"https://cn.czmanga.com/comic/chapter/yirenzhixia-dongmantang/0_{i}.html" for i in range(700)]
    ...
    async with aiohttp.ClientSession(headers=headers) as session:
        ...
        with open("docs/yrzx/漫画/一人之下.md", "w", encoding='utf-8') as f:
            for url in list(OrderedDict.fromkeys(urls_list).keys()):
                if not url.startswith("https"):
                    ...
                    f.write(f"![]({url})" + "\n")
            f.write(":::" + "\n")
        with open("docs/yrzx/漫画/一人之下.md", "r", encoding='utf-8') as f:
            lines = f.readlines()
        if lines:
            del lines[0]
            with open("docs/yrzx/漫画/一人之下.md", "w", encoding='utf-8') as f:
